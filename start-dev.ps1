...
$frontendEnv = "`$env:VITE_API_URL='http://127.0.0.1:9020'; `$env:VITE_ENABLE_LEGACY_SPRITES='true'"
if ($edgeFunctionsStarted) {
  $frontendEnv += "; `$env:VITE_EDGE_FUNCTIONS_BASE_URL='http://127.0.0.1:54321'; `$env:VITE_EDGE_FUNCTIONS_ANON_KEY='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJeXxjNni43kdQwgnWNReilDMblYTn_I0'"
}
...
Start-Process powershell -ArgumentList @(
  '-NoExit',
  '-Command',
  "$frontendEnv; Set-Location '$root/frontend'; npm run dev -- --host 127.0.0.1"
)
