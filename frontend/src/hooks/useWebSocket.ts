...
export function useWebSocket() {
  ...
  }, [addNarrative, addEntity, addPlayer, removeEntity, renderSessionStartProtocol, setCombat, setLoading, setMap, setOverlay, setPlayers, speakNarration, syncState, updateEntity])
